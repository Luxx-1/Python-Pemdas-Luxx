...
while i<banyak_jenis:
    ...
    if kode_potong[i]== "D" or kode_potong[i] == "d":
        ...
        jenis_potong.append("Input Salah")
        harga.append("")
...
print("   |Potong  |Satuan |Jenis   |Harga   ")
print("--------------------------------------") 

jumlah_bayar = 0
ls = 0
while ls <banyak_jenis:
    jumlah_bayar = jumlah_bayar+jumlah[ls]
    print ("%i    %s     %s    %i      %i" % (ls+1,jenis_potong[ls],harga[ls],banyak_potong[ls],jumlah[ls]))
    ls = ls+1
